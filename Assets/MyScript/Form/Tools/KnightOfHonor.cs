...
public class KnightOfHonor : Tool
{
    public KnightOfHonor(Card.CardSuit suit, Card.CardNumber number, Card.CardState state, Player owner, Game g)
        : base("Knight of Honor", "KnightOfHonor", "", suit, number, state, ToolType.NonTimeDelay, owner, g)
    {
